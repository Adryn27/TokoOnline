        ...
        <div class="col-md-6"> 
            <div class="product-body"> 
                ...
                <div class="product-options"> 
                    <ul class="size-option"> <li><span class="text-uppercase">Berat:</span></li> {{ $row->berat }} Gram </ul> 
                    <ul class="size-option"> <li><span class="text-uppercase">Stok:</span></li> {{ $row->stok }} </ul> 
                </div> 
