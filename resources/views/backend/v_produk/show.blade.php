                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="kategori_id" class="form-select @error('kategori_id') is-invalid @enderror" disabled>
                            ...
                            <option value="{{ $k->id }}" {{ old('kategori_id', $show->kategori_id == $k->id ? 'selected' :'') }}>{{ $k->nama_kategori }}</option>
                            @endforeach
                        </select>
                        @error('role')
                    ...
                    <div class="form-group">
                        <label>Detail</label>
                        <textarea name="detail" class="form-control @error('detail') is-invalid @enderror" id="ckeditor" disabled>
