              ...
              <div class="row pb-4">
                <div class="col-12">
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Masukkan Email" aria-label="Email" aria-describedby="basic-addon1"/>
                    @error('email')
