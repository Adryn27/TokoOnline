...
<html dir="ltr" lang="en">
  <head>
    ...
    <meta
      name="author"
      content="Willy Andryan"
    />
    <meta
      name="description"
      content="Project Toko Online Mata Kuliah Web Programming UBSI"
    />
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('backend/matrix-admin-bt5-master/assets/extra-libs/multicheck/multicheck.css') }}"
    />
    <link
      href="{{ asset('backend/matrix-admin-bt5-master/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css') }}"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    >
        ...
        <div class="scroll-sidebar">
          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link has-arrow waveseffect waves-dark"
                  href="#"
                  aria-expanded="false"
      ...
      <div class="page-wrapper">
        ...
        <footer class="footer text-center">
          Copyright &copy; 2024 | Toko Online | by 
          <a href="https://www.instagram.com/adryn_w">Willy Andryan</a>.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <!-- this page js -->
    <script src="{{ asset('backend/matrix-admin-bt5-master/assets/extra-libs/multicheck/datatable-checkbox-init.js')}}"></script>
    <script src="{{ asset('backend/matrix-admin-bt5-master/assets/extra-libs/multicheck/jquery.multicheck.js')}}"></script>
    <script src="{{ asset('backend/matrix-admin-bt5-master/assets/extra-libs/DataTables/datatables.min.js')}}"></script>
